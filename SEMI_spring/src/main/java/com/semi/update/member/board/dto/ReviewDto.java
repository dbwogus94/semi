...
public class ReviewDto {
	...
	public ReviewDto(int board_Category_No, int board_Group, int board_Group_No, int board_Tab, String id, String board_Member_Name, String board_Content) {
	...
	public ReviewDto(int board_No, String board_Category, int board_Category_No, int board_Group, int board_Group_No, int board_Tab, String id, String board_Member_Name, String board_Exercise_Name, String board_Title, String board_Content, Date board_Regdate, int board_Review_Score, String board_Exercise_Category, String board_Exercise_Url) {
